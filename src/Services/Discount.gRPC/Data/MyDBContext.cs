    ...
    public class MyDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Coupon>().HasData(
                 ...
                 new Coupon { Id = 3, ProductName = "Google Pixel 6", Description = "Google Pixel Discount", Amount = 120 },
                 ...
                 new Coupon { Id = 15, ProductName = "Lenovo Legion Duel", Description = "Lenovo Discount", Amount = 115 },
                 new Coupon { Id = 16, ProductName = "Black Shark 4", Description = "Black Shark Discount", Amount = 105 },
                 new Coupon { Id = 17, ProductName = "ZTE Axon 30", Description = "ZTE Discount", Amount = 55 },
                 new Coupon { Id = 18, ProductName = "Apple MacBook Pro", Description = "MacBook Discount", Amount = 200 },
